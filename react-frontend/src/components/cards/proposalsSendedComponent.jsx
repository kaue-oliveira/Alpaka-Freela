...
function ProposalsSendedComponent() {
        ...
        >
                ...
                {proposals.map((proposal) => (
                    ...
                    >
                        <span>
                            ...
                            recebida de <strong>{proposal.sender}</strong> há{" "}
                            {proposal.daysAgo} dias
                        </span>
                        <div>
                            <button
            ...
            {selectedProposal && (
                ...
                >
                    ...
                    >
                        <h3>
                            {selectedProposal.type} Freelancer recebida de{" "}
                        ...
                        <p>
                            ...
                            <br />
                            Estou entrando em contato para propor uma
                            colaboração freelancer com você devido à sua
                            experiência...
                        </p>
                        <button
...
export default ProposalsSendedComponent;
