    ...
    return (
         <div className={styles["extended-left-space"]}>
            <div className={styles.menu}>
                ...
                <a href=""><img src={Images.manTechEmoji} alt=""></img> Encontrar Freelancer</a>
                <a href=""><img src={Images.briefCaseEmoji} alt=""></img> Encontrar trabalho</a>
                <a href=""><img src={Images.globeEmoji} alt=""></img> Gerenciar conta / posts</a>
                <a href=""><img src={Images.laptopEmoji} alt=""></img> Caixa de entrada</a>
            </div>
        </div>
    )
}